...
M0  PARTIAL  Reference freeze
    ...
    bootable recovery media   TOOLING PASS  physical USB boot pending
...
| --- | --- | --- | --- |
| M0 Reference freeze | [M0](https://github.com/aien-dev/aienos/milestone/1) | [#17](https://github.com/aien-dev/aienos/issues/17) recovery media: tooling done ([procedure](docs/RECOVERY_MEDIA_MACHINE1.md)), physical boot pending | [#12](https://github.com/aien-dev/aienos/pull/12) Rust evidence tooling and clean snapshot ([9bd233d](https://github.com/aien-dev/aienos/commit/9bd233d)) |
